...
all_ids = list(pd.read_csv('../index_2018.csv').OBJECT_ID)
all_ids.extend(list(pd.read_csv('../index_2019.csv').OBJECT_ID))
all_ids.extend(list(pd.read_csv('../index_2020.csv').OBJECT_ID))
all_ids.extend(list(pd.read_csv('../index_2021.csv').OBJECT_ID))
